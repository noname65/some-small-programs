...
public class WebCrawlerTest4 {

    static String strurl = "https://www.dawenxue.net";
    static String strid = "/83060/";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int j = 1; (l = list.get(j-1)) != null; j++) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (start) {
                        ...
                        //file = new File(savepath+title+"/" + filepath + (j < 10 ? "/00" : (j < 100 ? "/0" : "/")) + j + line.substring(4, line.length() - 5).replace("/".charAt(0), "_".charAt(0)) + ".txt");
                        //if (!file.exists()) {
                        //file.createNewFile();
                        //}
                ...
                br.close();
                file = new File(savepath + title + "/" + filepath + (j < 100 ? (j < 10 ? "/00" : "/0") : "/") + j + result.get(0).replace("/".charAt(0), "_".charAt(0)) + ".txt");
                if (!file.exists()) {
                    file.createNewFile();
                }
                x = new PrintWriter(file);
